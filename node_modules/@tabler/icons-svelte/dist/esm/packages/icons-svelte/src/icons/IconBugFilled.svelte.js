...
/* src/icons/IconBugFilled.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bug-filled" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBugFilled extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBugFilled$1 = IconBugFilled;

export { IconBugFilled$1 as default };
//# sourceMappingURL=IconBugFilled.svelte.js.map
