...
/* src/icons/IconRvTruck.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "rv-truck" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRvTruck extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRvTruck$1 = IconRvTruck;

export { IconRvTruck$1 as default };
//# sourceMappingURL=IconRvTruck.svelte.js.map
