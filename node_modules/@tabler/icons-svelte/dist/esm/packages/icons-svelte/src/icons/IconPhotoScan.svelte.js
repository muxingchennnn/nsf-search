...
/* src/icons/IconPhotoScan.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "photo-scan" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPhotoScan extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPhotoScan$1 = IconPhotoScan;

export { IconPhotoScan$1 as default };
//# sourceMappingURL=IconPhotoScan.svelte.js.map
