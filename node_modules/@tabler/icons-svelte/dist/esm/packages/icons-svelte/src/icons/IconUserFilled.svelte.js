...
/* src/icons/IconUserFilled.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "user-filled" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconUserFilled extends SvelteComponent {
	constructor(options) {
		super();
...
var IconUserFilled$1 = IconUserFilled;

export { IconUserFilled$1 as default };
//# sourceMappingURL=IconUserFilled.svelte.js.map
