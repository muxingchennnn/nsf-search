...
/* src/icons/IconRouteX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "route-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRouteX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRouteX$1 = IconRouteX;

export { IconRouteX$1 as default };
//# sourceMappingURL=IconRouteX.svelte.js.map
