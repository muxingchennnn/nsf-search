...
/* src/icons/IconBedFlat.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bed-flat" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBedFlat extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBedFlat$1 = IconBedFlat;

export { IconBedFlat$1 as default };
//# sourceMappingURL=IconBedFlat.svelte.js.map
