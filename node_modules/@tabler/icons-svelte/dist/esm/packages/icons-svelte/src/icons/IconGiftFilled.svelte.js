...
/* src/icons/IconGiftFilled.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "gift-filled" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGiftFilled extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGiftFilled$1 = IconGiftFilled;

export { IconGiftFilled$1 as default };
//# sourceMappingURL=IconGiftFilled.svelte.js.map
