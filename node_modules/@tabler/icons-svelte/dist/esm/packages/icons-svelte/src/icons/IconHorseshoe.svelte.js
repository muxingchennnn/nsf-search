...
/* src/icons/IconHorseshoe.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "horseshoe" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconHorseshoe extends SvelteComponent {
	constructor(options) {
		super();
...
var IconHorseshoe$1 = IconHorseshoe;

export { IconHorseshoe$1 as default };
//# sourceMappingURL=IconHorseshoe.svelte.js.map
