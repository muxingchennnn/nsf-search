...
/* src/icons/IconPentagonX.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "pentagon-x" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPentagonX extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPentagonX$1 = IconPentagonX;

export { IconPentagonX$1 as default };
//# sourceMappingURL=IconPentagonX.svelte.js.map
