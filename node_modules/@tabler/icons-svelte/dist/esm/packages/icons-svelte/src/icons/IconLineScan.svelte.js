...
/* src/icons/IconLineScan.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "line-scan" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLineScan extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLineScan$1 = IconLineScan;

export { IconLineScan$1 as default };
//# sourceMappingURL=IconLineScan.svelte.js.map
