...
/* src/icons/IconPhotoVideo.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "photo-video" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconPhotoVideo extends SvelteComponent {
	constructor(options) {
		super();
...
var IconPhotoVideo$1 = IconPhotoVideo;

export { IconPhotoVideo$1 as default };
//# sourceMappingURL=IconPhotoVideo.svelte.js.map
