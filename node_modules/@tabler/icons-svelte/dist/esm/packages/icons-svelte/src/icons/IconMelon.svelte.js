...
/* src/icons/IconMelon.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "melon" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMelon extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMelon$1 = IconMelon;

export { IconMelon$1 as default };
//# sourceMappingURL=IconMelon.svelte.js.map
