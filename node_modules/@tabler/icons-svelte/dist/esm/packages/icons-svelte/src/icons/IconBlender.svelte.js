...
/* src/icons/IconBlender.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "blender" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBlender extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBlender$1 = IconBlender;

export { IconBlender$1 as default };
//# sourceMappingURL=IconBlender.svelte.js.map
