...
/* src/icons/IconLogin2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "login-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLogin2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLogin2$1 = IconLogin2;

export { IconLogin2$1 as default };
//# sourceMappingURL=IconLogin2.svelte.js.map
