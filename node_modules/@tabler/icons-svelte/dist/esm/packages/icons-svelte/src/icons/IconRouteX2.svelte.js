...
/* src/icons/IconRouteX2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "route-x-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRouteX2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRouteX2$1 = IconRouteX2;

export { IconRouteX2$1 as default };
//# sourceMappingURL=IconRouteX2.svelte.js.map
