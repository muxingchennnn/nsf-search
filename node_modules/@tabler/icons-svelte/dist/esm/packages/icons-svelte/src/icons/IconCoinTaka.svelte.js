...
/* src/icons/IconCoinTaka.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "coin-taka" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCoinTaka extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCoinTaka$1 = IconCoinTaka;

export { IconCoinTaka$1 as default };
//# sourceMappingURL=IconCoinTaka.svelte.js.map
