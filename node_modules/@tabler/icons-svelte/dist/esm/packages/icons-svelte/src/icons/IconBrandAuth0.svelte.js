...
/* src/icons/IconBrandAuth0.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "brand-auth0" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBrandAuth0 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBrandAuth0$1 = IconBrandAuth0;

export { IconBrandAuth0$1 as default };
//# sourceMappingURL=IconBrandAuth0.svelte.js.map
