...
/* src/icons/IconBurger.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "burger" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [
		[
			"path",
			{
				"d": "M4 15h16a4 4 0 0 1 -4 4h-8a4 4 0 0 1 -4 -4z"
			}
		],
		[
			"path",
...
var IconBurger$1 = IconBurger;

export { IconBurger$1 as default };
//# sourceMappingURL=IconBurger.svelte.js.map
