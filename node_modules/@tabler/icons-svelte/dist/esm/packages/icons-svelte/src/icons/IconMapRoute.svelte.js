...
/* src/icons/IconMapRoute.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "map-route" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMapRoute extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMapRoute$1 = IconMapRoute;

export { IconMapRoute$1 as default };
//# sourceMappingURL=IconMapRoute.svelte.js.map
