...
/* src/icons/IconBodyScan.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "body-scan" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBodyScan extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBodyScan$1 = IconBodyScan;

export { IconBodyScan$1 as default };
//# sourceMappingURL=IconBodyScan.svelte.js.map
