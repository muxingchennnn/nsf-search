...
/* src/icons/IconGrid4x4.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "grid-4x4" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGrid4x4 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGrid4x4$1 = IconGrid4x4;

export { IconGrid4x4$1 as default };
//# sourceMappingURL=IconGrid4x4.svelte.js.map
