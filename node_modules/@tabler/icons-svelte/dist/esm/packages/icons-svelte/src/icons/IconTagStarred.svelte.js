...
/* src/icons/IconTagStarred.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "tag-starred" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTagStarred extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTagStarred$1 = IconTagStarred;

export { IconTagStarred$1 as default };
//# sourceMappingURL=IconTagStarred.svelte.js.map
