...
/* src/icons/IconRobotFace.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "robot-face" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRobotFace extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRobotFace$1 = IconRobotFace;

export { IconRobotFace$1 as default };
//# sourceMappingURL=IconRobotFace.svelte.js.map
