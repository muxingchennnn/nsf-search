...
/* src/icons/IconGalaxy.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "galaxy" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGalaxy extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGalaxy$1 = IconGalaxy;

export { IconGalaxy$1 as default };
//# sourceMappingURL=IconGalaxy.svelte.js.map
