...
/* src/icons/IconCarGarage.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "car-garage" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCarGarage extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCarGarage$1 = IconCarGarage;

export { IconCarGarage$1 as default };
//# sourceMappingURL=IconCarGarage.svelte.js.map
