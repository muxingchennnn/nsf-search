...
/* src/icons/IconGridScan.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "grid-scan" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconGridScan extends SvelteComponent {
	constructor(options) {
		super();
...
var IconGridScan$1 = IconGridScan;

export { IconGridScan$1 as default };
//# sourceMappingURL=IconGridScan.svelte.js.map
