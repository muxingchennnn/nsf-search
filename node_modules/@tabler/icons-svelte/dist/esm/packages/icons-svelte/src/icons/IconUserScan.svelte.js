...
/* src/icons/IconUserScan.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "user-scan" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconUserScan extends SvelteComponent {
	constructor(options) {
		super();
...
var IconUserScan$1 = IconUserScan;

export { IconUserScan$1 as default };
//# sourceMappingURL=IconUserScan.svelte.js.map
