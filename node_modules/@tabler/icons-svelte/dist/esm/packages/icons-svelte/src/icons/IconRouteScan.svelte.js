...
/* src/icons/IconRouteScan.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "route-scan" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconRouteScan extends SvelteComponent {
	constructor(options) {
		super();
...
var IconRouteScan$1 = IconRouteScan;

export { IconRouteScan$1 as default };
//# sourceMappingURL=IconRouteScan.svelte.js.map
