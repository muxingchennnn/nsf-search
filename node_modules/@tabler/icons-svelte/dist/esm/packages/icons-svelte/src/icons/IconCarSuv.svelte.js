...
/* src/icons/IconCarSuv.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "car-suv" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCarSuv extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCarSuv$1 = IconCarSuv;

export { IconCarSuv$1 as default };
//# sourceMappingURL=IconCarSuv.svelte.js.map
