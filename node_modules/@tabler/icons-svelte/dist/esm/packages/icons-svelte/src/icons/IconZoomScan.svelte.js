...
/* src/icons/IconZoomScan.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "zoom-scan" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconZoomScan extends SvelteComponent {
	constructor(options) {
		super();
...
var IconZoomScan$1 = IconZoomScan;

export { IconZoomScan$1 as default };
//# sourceMappingURL=IconZoomScan.svelte.js.map
