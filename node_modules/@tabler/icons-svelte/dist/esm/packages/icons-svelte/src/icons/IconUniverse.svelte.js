...
/* src/icons/IconUniverse.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "universe" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
function instance($$self, $$props, $$invalidate) {
	...
	const iconNode = [
		...
		[
			"path",
			{
				"d": "M9 16m-1 0a1 1 0 1 0 2 0a1 1 0 1 0 -2 0"
			}
		]
	];
...
class IconUniverse extends SvelteComponent {
	constructor(options) {
		super();
...
var IconUniverse$1 = IconUniverse;

export { IconUniverse$1 as default };
//# sourceMappingURL=IconUniverse.svelte.js.map
