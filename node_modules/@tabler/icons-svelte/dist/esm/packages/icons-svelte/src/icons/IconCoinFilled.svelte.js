...
/* src/icons/IconCoinFilled.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "coin-filled" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconCoinFilled extends SvelteComponent {
	constructor(options) {
		super();
...
var IconCoinFilled$1 = IconCoinFilled;

export { IconCoinFilled$1 as default };
//# sourceMappingURL=IconCoinFilled.svelte.js.map
