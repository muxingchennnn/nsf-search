...
/* src/icons/IconLinkPlus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "link-plus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLinkPlus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLinkPlus$1 = IconLinkPlus;

export { IconLinkPlus$1 as default };
//# sourceMappingURL=IconLinkPlus.svelte.js.map
