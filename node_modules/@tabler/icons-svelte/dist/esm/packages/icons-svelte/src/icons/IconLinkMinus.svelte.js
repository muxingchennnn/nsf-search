...
/* src/icons/IconLinkMinus.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "link-minus" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconLinkMinus extends SvelteComponent {
	constructor(options) {
		super();
...
var IconLinkMinus$1 = IconLinkMinus;

export { IconLinkMinus$1 as default };
//# sourceMappingURL=IconLinkMinus.svelte.js.map
