...
/* src/icons/IconTextScan2.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "text-scan-2" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconTextScan2 extends SvelteComponent {
	constructor(options) {
		super();
...
var IconTextScan2$1 = IconTextScan2;

export { IconTextScan2$1 as default };
//# sourceMappingURL=IconTextScan2.svelte.js.map
