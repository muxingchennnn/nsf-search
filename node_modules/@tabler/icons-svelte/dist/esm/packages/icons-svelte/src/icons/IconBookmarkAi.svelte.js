...
/* src/icons/IconBookmarkAi.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "bookmark-ai" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconBookmarkAi extends SvelteComponent {
	constructor(options) {
		super();
...
var IconBookmarkAi$1 = IconBookmarkAi;

export { IconBookmarkAi$1 as default };
//# sourceMappingURL=IconBookmarkAi.svelte.js.map
