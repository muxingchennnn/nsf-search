...
/* src/icons/IconMagnetic.svelte generated by Svelte v3.55.0 */
...
function create_fragment(ctx) {
	let icon;
	let current;
	const icon_spread_levels = [{ name: "magnetic" }, /*$$props*/ ctx[1], { iconNode: /*iconNode*/ ctx[0] }];
...
class IconMagnetic extends SvelteComponent {
	constructor(options) {
		super();
...
var IconMagnetic$1 = IconMagnetic;

export { IconMagnetic$1 as default };
//# sourceMappingURL=IconMagnetic.svelte.js.map
